...
export const AWS_REGION = (process.env.REGION_AWS || process.env.AWS_REGION || "us-east-1") as string;
export const NEXTAUTH_URL = process.env.NEXTAUTH_URL as string;
export const NEXTAUTH_SECRET = process.env.NEXTAUTH_SECRET || "this-is-a-super-secret-string-for-the-hackathon-demo-only";
